...
Currently: a copy of the fused GDN decode post-conv kernel that triggers
...
@cache
def load() -> bool:
    if hasattr(torch.ops, "flashnext_pdl") and hasattr(torch.ops.flashnext_pdl, "gdn_post_conv_mtp"):
        return True
    from torch.utils.cpp_extension import load as _load

    build_dir = os.path.expanduser("~/.cache/vllm/flashnext_pdl")
    ...
    return hasattr(torch.ops.flashnext_pdl, "gdn_post_conv_mtp")
